...
*/
extern void Gpt_Pit0Ch0Notification(void);
extern void Gpt_Stm0Ch0Notification(void);
...
{
    (GPT_STM_MODULE), /* hardware module type */
    (uint8)(0U), /* hw instance no. */
    (uint8)0U, /* GPT physical channel no. */
    (Gpt_ClockSourceType)0U, 
    (boolean)TRUE, /* Freeze Enable */
    (Gpt_PrescalerType)(39U), /* STM Clock divider */
};
static const Gpt_HwPredefChannelConfigType Gpt_pInitPredefTimer_1us_24bitPB=
{
    (GPT_STM_MODULE), /* hardware module type */
    (uint8)(0U), /* hw instance no. */
    (uint8)0U, /* GPT physical channel no. */
...
static const Gpt_HwPredefChannelConfigType Gpt_pInitPredefTimer_1us_32bitPB=
{
    (GPT_STM_MODULE), /* hardware module type */
    (uint8)(0U), /* hw instance no. */
    (uint8)0U, /* GPT physical channel no. */
...
static const Gpt_HwPredefChannelConfigType *const Gpt_pInitPredefTimerChannelPB[GPT_HW_PREDEFTIMER_NUM]=
{
    ...
    &Gpt_pInitPredefTimer_1us_24bitPB,
    &Gpt_pInitPredefTimer_1us_32bitPB,
    NULL_PTR
};
...
static const Gpt_ChannelConfigType Gpt_InitChannelPB[GPT_CONF_CHANNELS_PB] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        ...
        &Gpt_Pit0Ch0Notification, /* Channel notification */
...
,
    {   /*GptChannelConfiguration_1 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Gpt_Stm0Ch0Notification, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(4294967295U), /* Maximum ticks value*/
