...
*/
#define MCU_CGM_NUMBER_OF_PCFS_REGS              ((uint8)6U)
...
#define McuClockSettingConfig_A_HighPerf   ((Mcu_ClockType)0U)

#define McuConf_McuClockSettingConfig_McuClockSettingConfig_A_HighPerf   ((Mcu_ClockType)0U)
